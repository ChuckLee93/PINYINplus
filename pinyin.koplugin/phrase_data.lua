--[[ 多音字词组辨音表 (自动生成, 勿手改)
来源: pypinyin 0.55 phrases_dict (mozillazg/pinyin-data 生态)
筛选: 2~6 字词组, 且词内至少一字读音与『生效默认读音』不同
...
return {
  ...
  ["屏声敛息"] = "bǐng shēng liǎn xī",
  ["屏声静气"] = "bǐng shēng jìng qì",
  ["屏弃"] = "bǐng qì",
  ["屏息"] = "bǐng xī",
  ["屏气"] = "bǐng qì",
  ...
  ["连更星夜"] = "lián gēng xīng yè",
  ["连更晓夜"] = "lián gēng xiǎo yè",
  ["连杆"] = "lián gǎn",
  ...
  ["鸿商富贾"] = "hóng shāng fù gǔ",
  ["鸿衣羽裳"] = "hóng yī yǔ cháng",
